...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Register auth routes (login, register, password reset, PIN, etc.)
  ...
  // Register product routes (listings, seller products, etc.)
  registerProductRoutes(app);

  // Register messages routes (DMs, conversations, reactions, etc.)
  registerMessagesRoutes(app);

  // Register social posts routes (The Plug - posts, likes, comments, reposts, etc.)
  registerSocialRoutes(app);

  // Register admin routes (users, products, metrics, platform settings, etc.)
  registerAdminRoutes(app);

  // Register user routes (profile, follow, block, report, etc.)
  ...
  // Auth routes are registered in ./routes/auth/index.ts via registerAuthRoutes(app)
  ...
  // Admin payment config route is now in ./routes/admin/index.ts
  ...
  // User role switcher is now in ./routes/users/index.ts via registerUsersRoutes(app)
  ...
  // Admin tickets routes are now in ./routes/admin/index.ts
  ...
  // WebSocket token endpoint is now in ./routes/auth/index.ts
  ...
  // Product routes are now registered in ./routes/products/index.ts via registerProductRoutes(app)

  // User routes are now registered in ./routes/users/index.ts via registerUsersRoutes(app)
  ...
  // Admin users and products routes are now in ./routes/admin/index.ts
  ...
  // Admin announcements route is now in ./routes/admin/index.ts

  // Social posts routes are now registered in ./routes/social/index.ts via registerSocialRoutes(app)

  // Location and username endpoints are now in ./routes/users/index.ts via registerUsersRoutes(app)
  ...
  // Admin metrics and platform settings routes are now in ./routes/admin/index.ts
...
Generate exactly ${questionCount} unique questions with varied topics.`;
  ...
  // User relationships (block/mute/report) are now in ./routes/users/index.ts via registerUsersRoutes(app)
  ...
  // Admin test email route is now in ./routes/admin/index.ts
  ...
  // Admin reseller withdrawals routes are now in ./routes/admin/index.ts
